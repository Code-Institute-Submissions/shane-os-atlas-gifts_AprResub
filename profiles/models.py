...
class UserAccount(models.Model):
    ...
    official_address_line1 = models.CharField(max_length=100, null=True, blank=True)
    official_address_line2 = models.CharField(max_length=100, null=True, blank=True)
    official_address_line3 = models.CharField(max_length=100, null=True, blank=True)
